...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        userAccounts.add(new Manager("JazMasungit@dlsl.edu.ph","password123",0001,"Justine Margaret Candelaria","Sa ilalim ng ferris wheel ng ek",1,"0986754432", 1000));
        userAccounts.add(new Reception("LuisPogi@dlsl.edu.ph", "password1234", 0002, "Luis Matthew Quinton", "Malapit sa bahay ni raviza", 2, "09984365", 2000));
        ...
        while (true) {
            ...
            if (loggedInUser instanceof Guest){
                ...
                // Placeholder for Receptionist Menu
                System.out.println("Welcome, Receptionist!");
                System.out.println("Receptionist menu is not implemented yet.");
